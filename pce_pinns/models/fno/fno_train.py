...
from pce_pinns.models.fno import fno2d_gym as gym
...
def train_fno(args):
    # Parser will open train/test data in memmap
    ...
    if verbose:
        def pprint(dictionary):
            return json.dumps(dictionary, sort_keys=True,indent=2) if dictionary else "<default>"
        ...
        print("\nConfiguration")
        print(" * data loader:" + pprint(dl_cfg))   
        print(" *       model:" + pprint(model_cfg))
        print(" *   optimizer:" + pprint(opt_cfg))
        print(" *        meta:" + pprint(meta))
...
def create_sin_cos_test_data():
    ...
    # Save data
    d_proc = Path('data/interim/temp/sincos/fno')
    f_xtrain = d_proc / "xtrain.npy" 
    f_xtest = d_proc / "xtest.npy" 
    f_ytrain = d_proc / "ytrain.npy" 
    f_ytest = d_proc / "ytest.npy" 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir_load_simdata', default=None, type=str,
            help='Directory to logged simulation data, e.g., data/interim/temp/lorenz96/fno.')
    parser.add_argument('--dir_load_model', default=None, type=str,
            help='Directory to stored model and config, e.g., models/temp/lorenz96/fno/.') #t00_d3c3m44 
    ...
    d_out = Path('models/temp/lorenz96/fno')
    d = {
            "data_loader": {
    ...
    ###################
    import time
    # from pce_pinns.models.fcnn.neural_net import eval
    from pce_pinns.models.losses import calculate_losses
